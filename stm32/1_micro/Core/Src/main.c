...
/* USER CODE BEGIN PV */
#define AUDIO_REG 256
int32_t RecBuf0[AUDIO_REG];
int32_t RecBuf1[AUDIO_REG];
...
int main(void)
{
  ...
  MX_DFSDM1_Init();
  /* USER CODE BEGIN 2 */
  HAL_DFSDM_FilterRegularStart_DMA(&hdfsdm1_filter0, RecBuf0, AUDIO_REG);
  HAL_DFSDM_FilterRegularStart_DMA(&hdfsdm1_filter1, RecBuf1, AUDIO_REG);
  /* USER CODE END 2 */
